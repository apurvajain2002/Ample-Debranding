...
const tableHeadValues = [
  ...
  { optionKey: "Candidate Name", optionValue: "candidateName", allowFilter: true },
  { optionKey: "Current Organization", optionValue: "currentOrganization", allowFilter: true, },
  { optionKey: "Designation", optionValue: "designation", allowFilter: true, },
  { optionKey: "CTC (Rs. Lacs)", optionValue: "ctc", allowFilter: true, },
  { optionKey: "Interviewed For", optionValue: "interviewedFor", allowFilter: true, },
  { optionKey: "TimeLine (MMYY)", optionValue: "timeline", allowFilter: true, },
  { optionKey: "Interview Status", optionValue: "interviewStatus", allowFilter: true, },
  { optionKey: "Interviewed So For", optionValue: "interviewedSoFor", allowFilter: true, },
];
...
const SearchCandidates = () => {
  ...
  const selectColumnListCountriesTable = [
    { optionKey: "Select Column", optionValue: "" },
    { optionKey: "Candidate Name", optionValue: "candidateName" },
  ];
    ...
    <div className="container">
      ...
      <div className="createEditMasters">
        <Routes>
          ...
          <Route
            path="/*"
            element={<NoRouteFound navigateToPath={"/admin/search-candidates"} />}
          />
        </Routes>
      </div>
      <h3>Candidates List</h3>
      <div className="showJobs bodybox-bodywr createRole" style={{ marginTop: "0px" }}>
        <TableComponent
          tableHeading="Search Candidates"
          tableName={tableName}
