...
const ReportPage1 = () => {
  ...
  return (
    ...
    >
      ...
      <section className="report-table-wr-mt report-table-wr"
      ...
      >
        ...
        <img src="images-3/univercity-ico.svg" alt="University Icon" />
                ...
                <div className="ac-inf-right">
                  <h4>
                    {academic.degreeName} ({academic.levelOfEducation})
                  </h4>
                  <p>{academic.universityName}</p>
                  <p>
                    <span>
                      <img src="images-3/calender.svg" alt="Calendar" />
                    </span>
                    {`${
      ...
      style={{width:"96%" , marginLeft: "2%",marginTop:"2%", height:"295px" }}>
        {" "}
        {/* css not found */}
              ...
              <tr key={experience.workExperienceId}>
                <td>
                  <div className="com-logo">
                    <img
                      src={`images-3/company-${index + 1}.png`}
